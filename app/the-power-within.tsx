...
export default function ThePowerWithinPage() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const productTitle = 'The Power Within';
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <Text style={styles.title}>The Power Within <Text style={styles.formatText}>(pdf.epub)</Text></Text>
      <Text style={styles.authorText}>by Ashwa Aashard</Text>
      <View style={styles.priceContainer}>
          <Text style={styles.priceText}>
            was <Text style={styles.originalPrice}>1000</Text> now <Text style={styles.discountPrice}>500ksh</Text>
          </Text>
        </View>
        ...
        <Text style={styles.descriptionText}>
          The Power Within: The Secret Behind Emotions You Didn’t Know 
          unravels the hidden origins of emotions and how they continue to
           shape our lives today. Emotions weren’t just randomly designed—they
            evolved as powerful mechanisms to help us navigate challenges, 
            make decisions, and survive. From fear to love, from anger to joy,
             every feeling carries a deeper purpose rooted in our history. 
             This book takes you on a journey to understand why you feel 
             the way you do and how unlocking this knowledge can give you
              greater control over your life, decisions, and personal growth.
        </Text>
